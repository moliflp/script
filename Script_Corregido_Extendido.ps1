    ...
    try {
        ...
        if ($GPU -match "NVIDIA") {
            try {
                ...
                Set-ItemProperty -Path "HKLM:\SYSTEM\CurrentControlSet\Control\Class\{4d36e968-e325-11ce-bfc1-08002be10318}\0000" -Name "EnableULPS" -Value 0
...
function Show-History {
    ...
    Write-Host "  Drivers instalados: $(${global:ExecutionHistory}.Stats.DriversInstalled)" -ForegroundColor Gray
    ...
    Write-Host "  DNS optimizados: $(${global:ExecutionHistory}.Stats.DNSOptimized)" -ForegroundColor Gray
    Write-Host ""
    ...
    while ($true) {
        ...
        switch ($selection) {
            ...
            "13" { 
                ...
                Write-Host "  Operaciones realizadas: $(${global:ExecutionHistory}.Operations.Count)" -ForegroundColor Gray
                Write-Host "  Errores: $(${global:ExecutionHistory}.Errors.Count)" -ForegroundColor Red
                Write-Host "  Advertencias: $(${global:ExecutionHistory}.Warnings.Count)" -ForegroundColor Yellow
                Pause
                exit
            }
            default { Write-Host "  [!] Opción inválida." -ForegroundColor Red }
...
# --- CÓDIGO AÑADIDO DESDE OTROS SCRIPTS ---
        ...
        $hardwareInfo = "$(${global:ExecutionHistory}.SystemInfo.Hardware.CPU), $(${global:ExecutionHistory}.SystemInfo.Hardware.GPU), $(${global:ExecutionHistory}.SystemInfo.Hardware.RAM)"
        ...
        while ($true) {
            ...
            switch ($mainChoice) {
                ...
                "11" {
                    ...
                    Write-Host "Archivos modificados: $(${global:ExecutionHistory}.Stats.FilesModified)"
                    Write-Host "Configuraciones cambiadas: $(${global:ExecutionHistory}.Stats.SettingsChanged)"
                    Write-Host "Elementos eliminados: $(${global:ExecutionHistory}.Stats.ItemsRemoved)"
                    Write-Host "Drivers instalados: $(${global:ExecutionHistory}.Stats.DriversInstalled)"
                    Write-Host "Programas instalados: $(${global:ExecutionHistory}.Stats.ProgramsInstalled)"
                    Write-Host "Servicios deshabilitados: $(${global:ExecutionHistory}.Stats.ServicesDisabled)"
                    Write-Host "Optimizaciones de juegos: $(${global:ExecutionHistory}.Stats.GameOptimizations)"
                    Write-Host "DNS optimizados: $(${global:ExecutionHistory}.Stats.DNSOptimized)"
                    Pause
                "12" { 
